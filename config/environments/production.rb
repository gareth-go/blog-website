...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = ['https://blog-community.me', /https:\/\/blog-community.*/]
  ...
  config.action_mailer.default_url_options = { host: 'https://blog-community.me' }
